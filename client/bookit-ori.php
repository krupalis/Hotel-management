			 ...
			 <div id="form_wrapper" class="form_wrapper">
					<form class="register active" method="post" enctype="multipart/form-data">
						<h3>Room Book</h3>
							...
							<div>
								<label>Name:</label>
								<input type="text" name=""  value="<?php echo $_SESSION['user_name']?>"/>
							...
							<div>
								...
								<input type="date" size="12" id="inputField" name="s_dt" /> 
								<span class="error">This is an error</span>
							</div>
							<div>
								<label>Departure Date:</label>
								<input type="date" size="12" id="inputField2" name="e_dt" /> 
</br>
<input type="text" size="12" id="numdt" name="numdt" /> 
